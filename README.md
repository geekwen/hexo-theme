...
```
theme_image: /path/to/image.jpg
```


2. 图片说明的 class

给 image 加上 has-info 的 class，那它后面紧接着的那一段话就是成为该图片的说明

```
{% img has-info /path/to/image.jpg %}

有不少地方可以看到1-3个人在街边演奏，很奇妙。演奏的曲子也挺好听的。不喜欢的话，也不要开枪，会把他们吓跑的。
```
